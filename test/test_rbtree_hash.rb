...
class TestRBTreeHash < Test::Unit::TestCase
  def __test_random
    h = RBTreeHash.new
    10000.times do |idx|
      key = rand(100)
  ...
  if RUBY_VERSION >= '1.9.0'
    # In contrast to RadixTree, RBTreeHash just uses String#<=> as-is
    def test_encoding
      h = RBTreeHash.new
